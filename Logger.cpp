...
{
public:
    FileLogger(const std::string& filename, std::size_t max_size) : filename_(filename), max_size_(max_size), current_size_(0)
    {
...
{
public:
    Log(LogLevel level, const std::string& message) : level_(level), message_(message)
    {
    ...
    static void set_file_logger(const std::string& filename, std::size_t max_size)
    {
